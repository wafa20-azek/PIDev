...
import static edu.dottn.services.CodeQr.generateQRcode;
...
public class EventDetailController implements Initializable {
    ...
    private void part(ActionEvent event) throws IOException, WriterException {
        ...
        String path = "C:\\Users\\WAFA\\Documents\\NetBeansProjects\\PIDEV\\src\\Quote.png";
        String charset = "UTF-8";
        Map<EncodeHintType, ErrorCorrectionLevel> hashMap = new HashMap<EncodeHintType, ErrorCorrectionLevel>();
        hashMap.put(EncodeHintType.ERROR_CORRECTION, ErrorCorrectionLevel.L);
        generateQRcode(a.getName()+" est enregistrer dans la liste des participant a l'event : "+us.getUser().getName(), path, charset, hashMap, 400, 400);
