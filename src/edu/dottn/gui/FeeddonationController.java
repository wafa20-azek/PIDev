...
public class FeeddonationController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        hellouserText.setText("Welcome to the donation space, "+us.getUser().getName().toUpperCase());
            ...
            feed1.setOnMouseClicked(event->{
                try {
                    ...
                    try {
                        ...
                        FXMLLoader loader1 = new FXMLLoader(getClass().getResource("PostInformationsUser.fxml"));
                        AnchorPane root1 = loader1.load();
                        PostInformationsUserController controller = loader1.getController();
